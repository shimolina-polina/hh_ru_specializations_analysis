...
def main():
    ...
    st.success(f"Для сециальности {specialist} количество вакансий: {row_count}")
    ...
    # Диаграмма топ-10 навыков для специальности
    skills_counts = {}
